...
**Publication status:** `0.1.0-alpha.2` is publicly pullable from Docker Hub and
...
2. In **Container Manager → Registry**, search for and download
   `melodysdreamj/hanji:0.1.0-alpha.2` from Docker Hub. GHCR remains available
...
2. Select the immutable version tag `0.1.0-alpha.2`. DSM automatically chooses
