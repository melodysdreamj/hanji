...
```text
melodysdreamj/hanji:0.2.0-alpha
```
...
1. Pull `melodysdreamj/hanji:0.2.0-alpha` from Docker Hub.
...
```bash
HANJI_VERSION=0.2.0-alpha # replace with the new immutable release tag
