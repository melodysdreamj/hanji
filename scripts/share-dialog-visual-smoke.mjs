  ...
  return {
    ...
    normalizedContract: {
      main: [
        ...
        'Notion currently implements many controls as role=button divs; Hanji should keep semantic, accessible controls while preserving the visible grouping and density.',
      ],
      permissionMenu: [
