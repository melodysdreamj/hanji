...
async function assertBasicBlocksVisualContract(page, seed, variant) {
  ...
  assert(metrics.blocks.toggle.caretWidth >= 22 && metrics.blocks.toggle.caretWidth <= 28, `toggle caret hitbox should stay Notion-like: ${JSON.stringify(metrics.blocks.toggle)}`);
