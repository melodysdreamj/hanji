...
const DEFAULT_PAGE_ID = '9d2efe69-e7b1-4fd2-8201-035dbe787bdb';
const DEFAULT_WORKSPACE_ID = '019f3550-d8a9-7f88-b113-26e279d7ee67';
...
let options = {
  ...
  userId: process.env.NOTIONLIKE_SMOKE_USER_ID ?? '',
...
async function main() {
  ...
  await context.addInitScript(({ refreshToken, workspaceId }) => {
    ...
    window.localStorage.setItem('notionlike:theme', 'dark');
  }, {
