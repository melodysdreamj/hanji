...
const defaultBaseUrl = process.env.HANJI_VISUAL_BASE_URL ?? 'http://127.0.0.1:8787';
...
Captures desktop and mobile screenshots from a running Hanji EdgeBase app.

Options:
  --base-url <url>          App URL. Defaults to HANJI_VISUAL_BASE_URL or ${defaultBaseUrl}
