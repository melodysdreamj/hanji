...
async function main() {
  console.log('Deployment verification target: local EdgeBase-linked Hanji app');
  ...
  if (!options.skipDocker) {
    ...
    if (!options.dockerTag) {
      generatedDockerTag = `hanji-edgebase-verify:${Date.now()}`;
...
Runs the deployment-oriented Hanji verification suite:
- web static build
