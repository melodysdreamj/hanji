...
describe("formatDateForProperty", () => {
  ...
  it("uses Korean long format with year for Notion-imported date properties under a ko locale", () => {
...
describe("formatNotionTimestamp", () => {
  ...
  it("formats timestamps in Korean with 오전/오후 under a ko locale", () => {
    vi.stubGlobal("navigator", { language: "ko-KR" });
    const local = new Date(2026, 6, 4, 9, 5);
