...
import { makeView } from "./editorTestUtils";
...
describe("TableView", () => {
  ...
  it("renders select chips and checkbox cells from row values", () => {
    ...
    const statusCells = screen.getAllByRole("button", { name: "Edit Status select" });
    expect(statusCells.map((cell) => cell.textContent)).toEqual(["Todo", "Done", "Todo"]);
