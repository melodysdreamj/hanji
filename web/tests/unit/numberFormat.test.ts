...
describe("formatNumberValue", () => {
  ...
  it("formats with thousands separators", () => {
    expect(formatNumberValue(1234567, "comma")).toBe(
      new Intl.NumberFormat("en-US", { maximumFractionDigits: 6 }).format(1234567)
    );
  });
  ...
  it("formats with the active Korean application locale", async () => {
