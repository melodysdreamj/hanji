    ...
    rules: {
      ...
      "no-restricted-syntax": [
        "error",
        {
          ...
          message:
            "Browser code must use Notionlike backend functions instead of direct EdgeBase db() access.",
        },
        {
          selector: "CallExpression[callee.property.name='table']",
          message:
            "Browser code must use Notionlike backend functions instead of direct EdgeBase table() access.",
        },
      ],
    },
  },
