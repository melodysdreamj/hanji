...
export const CheckIcon = (p: HanjiIconProps) => (
  <IconSvg {...p}>
    <path d="m4.2 10.2 3.5 3.4 8-8.2" />
  </IconSvg>
);

export const X = (p: HanjiIconProps) => (
  <IconSvg {...p}>
    <path d="m5.3 5.3 9.4 9.4" />
    <path d="m14.7 5.3-9.4 9.4" />
  </IconSvg>
);
...
export const Settings = (p: HanjiIconProps) => (
  <IconSvg {...p}>
    ...
    <path d="m14.8 5.2-1.5 1.5" />
    <path d="m6.7 13.3-1.5 1.5" />
  </IconSvg>
);
...
export const NoteMicIcon = (p: HanjiIconProps) => (
  <PhosphorIconSvg {...p} icon={PhosphorFileAudio} />
);
...
export const GlobeIcon = (p: HanjiIconProps) => (
  <IconSvg {...p}>
    <circle cx="10" cy="10" r="6.2" />
    <path d="M3.8 10h12.4" />
    <path d="M10 3.8c1.7 1.6 2.5 3.6 2.5 6.2s-.8 4.6-2.5 6.2" />
    <path d="M10 3.8C8.3 5.4 7.5 7.4 7.5 10s.8 4.6 2.5 6.2" />
  </IconSvg>
);
...
export const DragHandleIcon = (p: HanjiIconProps) => (
  <IconSvg {...p} stroke="none" fill="currentColor">
    <circle cx="7.3" cy="5" r="1" />
    <circle cx="12.7" cy="5" r="1" />
    <circle cx="7.3" cy="10" r="1" />
    <circle cx="12.7" cy="10" r="1" />
    <circle cx="7.3" cy="15" r="1" />
    <circle cx="12.7" cy="15" r="1" />
  </IconSvg>
);
...
export const TextAlignIcon = (p: HanjiIconProps) => (
  <IconSvg {...p}>
    <path d="M4.2 5h11.6" />
    <path d="M10 5v9.8" />
    <path d="M7.4 14.8h5.2" />
  </IconSvg>
);
...
export const UserIcon = (p: HanjiIconProps) => (
  <IconSvg {...p}>
    ...
    <path d="M5.1 16c.7-2.7 2.5-4.1 4.9-4.1s4.2 1.4 4.9 4.1" />
  </IconSvg>
);
...
export const Database = (p: HanjiIconProps) => (
  <IconSvg {...p}>
    <ellipse cx="10" cy="5.2" rx="5.6" ry="2.2" />
    <path d="M4.4 5.2v7.9c0 1.2 2.5 2.2 5.6 2.2s5.6-1 5.6-2.2V5.2" />
    <path d="M4.4 9.2c0 1.2 2.5 2.2 5.6 2.2s5.6-1 5.6-2.2" />
  </IconSvg>
);
...
export const VolumeIcon = (p: HanjiIconProps) => (
  <IconSvg {...p}>
    <path d="M4.7 11.9H3.4V8.1h1.3l3.5-2.6v9Z" />
    <path d="M12.3 8.1a3 3 0 0 1 0 3.8" />
    <path d="M14.4 6a5.6 5.6 0 0 1 0 8" />
  </IconSvg>
);
