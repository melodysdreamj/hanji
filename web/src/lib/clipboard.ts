export const NOTIONLIKE_BLOCKS_MIME = "application/x-notionlike-blocks";
export const NOTIONLIKE_TABLE_ROWS_MIME = "application/x-notionlike-table-rows";
