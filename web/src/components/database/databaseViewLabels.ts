...
export function databaseViewLabels() {
  ...
  return {
    additionalSettings: tr("additionalSettings"),
    advancedSettings: tr("advancedSettings"),
    advancedSubitemSettings: tr("advancedSubitemSettings"),
    ...
    automaticDateShifting: tr("automaticDateShifting"),
    automations: tr("automations"),
    avoidWeekends: tr("avoidWeekends"),
    avoidWeekendsDescription: tr("avoidWeekendsDescription"),
    backToProperties: tr("backToProperties"),
    backToPropertyList: tr("backToPropertyList"),
    backToViewSettings: tr("backToViewSettings"),
    blockedByPropertyName: tr("blockedByPropertyName"),
    blockingPropertyName: tr("blockingPropertyName"),
    ...
    dependenciesDescription: tr("dependenciesDescription"),
    dependencyShiftMaintain: tr("dependencyShiftMaintain"),
    dependencyShiftNone: tr("dependencyShiftNone"),
    dependencyShiftOverlap: tr("dependencyShiftOverlap"),
    keepProperties: tr("keepProperties"),
    endDate: tr("endDate"),
    day: tr("day"),
    ...
    filter: tr("filter"),
    flattenedList: tr("flattenedList"),
    ...
    noDateProperty: tr("noDateProperty"),
    ...
    parentItemPropertyName: tr("parentItemPropertyName"),
    parentsAndSubitems: tr("parentsAndSubitems"),
    parentsOnly: tr("parentsOnly"),
    ...
    removeProperties: tr("removeProperties"),
    ...
    saveChanges: tr("saveChanges"),
    saveDependencySettings: tr("saveDependencySettings"),
    separateStartEndDates: tr("separateStartEndDates"),
    ...
    showNestingToggleOnTitle: tr("showNestingToggleOnTitle"),
    showAll: tr("showAll"),
    ...
    subitemPropertyName: tr("subitemPropertyName"),
    subitemFilter: tr("subitemFilter"),
    subitems: tr("subitems"),
    subitemsDescription: tr("subitemsDescription"),
    subitemsDisplay: tr("subitemsDisplay"),
    subitemsOnly: tr("subitemsOnly"),
    taskFeatureOn: tr("taskFeatureOn"),
    tall: tr("tall"),
    ...
    turnOnDependencies: tr("turnOnDependencies"),
    turnOnSubitems: tr("turnOnSubitems"),
    turnOff: tr("turnOff"),
    turnOffDependencies: tr("turnOffDependencies"),
    turnOffSubitems: tr("turnOffSubitems"),
    type: tr("type"),
    ...
    viewTypeDescriptions: {
      ...
      form: tr("viewTypeDescriptions.form"),
    ...
    nestedInToggle: tr("nestedInToggle"),
    toast: {
